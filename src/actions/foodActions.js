import {FETCH_FOOD_LIST,FETCH_FOOD_DETAIL,FETCH_PAGE,
    FETCH_RECIPE_LIST,FETCH_RECIPE_DETAIL,FETCH_RECIPE_COUNT,FETCH_RECIPE_PAGE,
    FETCH_RECIPE_POSTERS,FETCH_RECIPE_MAKES,FETCH_FIND_LIST,FETCH_FIND_PAGE} from "./types";
...
// reducers의 디폴트 함수를 호출하려면 dispatch() 사용
// dispatch() 호출하면 reducers의 action으로 자동으로 값이 들어간다.
// type이 뭔지에 따라 payload 값이 들어감
// => redux 라이브러리가 이 흐름을 자동으로 하게 해줌